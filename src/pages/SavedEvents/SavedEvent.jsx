...
const SavedEvent = () => {
  ...
  const removeEvent = async (id) => {
    try {
      ...
      // Update localStorage
      const updatedBookmarks = getBookmarks().filter(eventId => eventId !== id);
  ...
  return (
    <div>
      <div className='mt-6'>
        <h1 className='text-2xl font-bold text-gray-900 dark:text-gray-700'>Saved Events</h1>
          ...
          {filteredEvents.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">
                {events.length === 0 ? "No saved events yet" : "No matching saved events"}
              </h3>
